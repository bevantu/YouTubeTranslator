...
function tokenizeText(text, langCode) {
  ...
  // For western languages: keep contractions whole (e.g. don't, it's, I'm)
  // Pattern: word chars optionally followed by apostrophe+word chars (handles don't, it's, I'm, I've etc.)
  const words = text.match(/[\w\u00C0-\u024F\u0400-\u04FF\u0600-\u06FF\u0900-\u097F\u0E00-\u0E7F\u3040-\u309F\u30A0-\u30FF\uAC00-\uD7AF]+(?:'[a-z]+)?|[^\s\w]+/gi);
  return words || [];
}
